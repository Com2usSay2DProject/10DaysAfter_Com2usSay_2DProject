...
namespace CityBuilderCore
{
    ...
    public class ItemQuantity
    {
        ...
        public static ItemQuantity operator +(ItemQuantity a) => a;
        public static ItemQuantity operator -(ItemQuantity a) => new ItemQuantity(a.Item, -a.Quantity);

        public static ItemQuantity operator *(ItemQuantity q, int n) => new ItemQuantity(q.Item, q.Quantity * n);
        public static ItemQuantity operator /(ItemQuantity q, int n) => new ItemQuantity(q.Item, q.Quantity / n);
        public static ItemQuantity operator +(ItemQuantity q, int n) => new ItemQuantity(q.Item, q.Quantity + n);
        public static ItemQuantity operator -(ItemQuantity q, int n) => new ItemQuantity(q.Item, q.Quantity - n);
