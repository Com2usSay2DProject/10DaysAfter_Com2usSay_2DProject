...
namespace CityBuilderCore
{
    ...
    public class TerrainModifier : ExtraDataBehaviour
    {
        ...
        public IEnumerable<TreeInstance> RemoveTrees(Vector2Int point, int index = -1)
        {
        ...
        public IEnumerable<TreeInstance> RemoveTrees(Vector2Int point, IEnumerable<int> indices)
        {
            var trees = new List<TreeInstance>();
        ...
        public TreeInstance AddTree(Vector2Int point, int index = 0, float height = 1f, float width = 1f, float color = 1f)
        {
        ...
        public TreeInstance AddTree(TreeInstance template, int index = 0)
        {
            if (index < 0)
                index = UnityEngine.Random.Range(0, _terrain.terrainData.treePrototypes.Length);
        ...
        public IEnumerable<TreeInstance> GetTrees(Vector2Int point, int index)
        {
            for (int i = _trees.Count - 1; i >= 0; i--)
            {
                var tree = _trees[i];
        ...
        public IEnumerable<TreeInstance> GetTrees(Vector2Int point, IEnumerable<int> indices)
        {
            for (int i = _trees.Count - 1; i >= 0; i--)
            {
                var tree = _trees[i];
