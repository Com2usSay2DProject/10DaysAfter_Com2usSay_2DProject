...
namespace CityBuilderCore
{
    ...
    public interface IBuildingManager
    {
        ...
        /// <returns></returns>
        T Add<T>(Vector3 position, Quaternion rotation, T prefab, Action<T> initializer = null, UndoRedoActions undoRedoActions = null) where T : Building;
        /// <summary>
        /// creates a building from save meta data, data is not loaded yet
        /// </summary>
        /// <param name="metaData">the meta data containing the building type, location, data</param>
        /// <returns>the newly created building</returns>
        IBuilding Add(BuildingMetaData metaData, UndoRedoActions undoRedoActions = null);
