...
Single	ignore additional")]
        ...
        public bool Scale;
        [Tooltip("building rotation will be applied to the addon")]
        public bool Rotate;
        ...
        public virtual void Add(Building building)
        {
            building.AddAddon(this);
        }
        ...
        public virtual void InitializeAddon()
        {
            ...
            if (Rotate)
                transform.localRotation = Building.Rotation.GetRotation();
        }
        /// <summary>
