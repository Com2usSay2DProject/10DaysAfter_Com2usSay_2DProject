    ...
    public class BuildingBuilder : PointerToolBase
    {
        ...
        protected virtual void build(IEnumerable<Vector2Int> points)
        {
            ...
            foreach (var point in points)
            {
                ...
                Built?.Invoke(buildingManager.Add(_gridPositions.GetWorldPosition(_rotation.RotateOrigin(point, BuildingInfo.Size)), _rotation.GetRotation(), BuildingInfo.GetPrefab(_index), undoRedoActions: undoRedoActions));
