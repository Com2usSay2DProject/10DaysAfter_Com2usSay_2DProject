...
namespace CityBuilderCore
{
    ...
    public class ExpandableBuildingInfo : BuildingInfo
    {
        ...
        [Tooltip("how many points the building is expanded at a time(size of each repetition)")]
        public Vector2Int SizeStep = Vector2Int.one;
        ...
        public Vector2Int PositiveStep => new Vector2Int(Mathf.Max(1, SizeStep.x), Mathf.Max(1, SizeStep.y));
        ...
        public override IEnumerable<Vector2Int> GetPoints(BuildingMetaData metaData)
        {
            var expansion = JsonUtility.FromJson<ExpandableBuilding.ExpandableBuildingData>(metaData.Data).Expansion;

            return PositionHelper.GetStructurePositions(metaData.Point, Size + expansion + SizePost, BuildingRotation.Create(metaData.Rotation));
        }
        ...
        public override IBuilding Create(BuildingMetaData metaData, Transform parent)
        {
            var expansion = JsonUtility.FromJson<ExpandableBuilding.ExpandableBuildingData>(metaData.Data).Expansion;
