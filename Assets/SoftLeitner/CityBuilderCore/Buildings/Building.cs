...
namespace CityBuilderCore
{
    ...
    public class Building : MessageReceiver, IBuilding, ISaveData
    {
        ...
        public virtual void Add(IEnumerable<Vector2Int> points, UndoRedoActions undoRedoActions = null) { }
        public virtual IEnumerable<Vector2Int> Remove(IEnumerable<Vector2Int> points, UndoRedoActions undoRedoActions = null)
        {
            var changedPoints = GetPoints();
            Terminate();
            undoRedoActions?.Add(new BuildingRemoval(this));
