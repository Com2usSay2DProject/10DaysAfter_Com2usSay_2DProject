...
//     version 1.13.0
//     from Assets/02. Scripts/TilemapCliker/Test/Mouse.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/02. Scripts/TilemapCliker/Test/Mouse.inputactions".
/// </summary>
/// <remarks>
...
public partial class @MouseInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""MouseClick"",
            ""id"": ""6b7979ad-1003-4855-9517-c4e17959fcca"",
            ""actions"": [
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""3372359e-fa06-4de0-95da-6b670161de2f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""MousePosition"",
                    ""type"": ""Value"",
                    ""id"": ""180a3da5-3468-4050-9917-0066d2a6480f"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""fb098e3b-3ea6-40fa-a867-8199c5137e56"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ff1056b4-685c-44fc-9038-f7331896edab"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@MouseInput()
    {
        UnityEngine.Debug.Assert(!m_MouseClick.enabled, "This will cause a leak and performance issues, MouseInput.MouseClick.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "MouseClick".
    /// </summary>
    public struct MouseClickActions
    {
        ...
        /// </summary>
        public MouseClickActions(@MouseInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "MouseClick/MouseClick".
        /// </summary>
        public InputAction @MouseClick => m_Wrapper.m_MouseClick_MouseClick;
        /// <summary>
        /// Provides access to the underlying input action "MouseClick/MousePosition".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="MouseClickActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// </remarks>
        /// <seealso cref="MouseClickActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="MouseClickActions.UnregisterCallbacks(IMouseClickActions)" />.
        /// </summary>
        /// <seealso cref="MouseClickActions.UnregisterCallbacks(IMouseClickActions)" />
        ...
        /// </remarks>
        /// <seealso cref="MouseClickActions.AddCallbacks(IMouseClickActions)" />
        /// <seealso cref="MouseClickActions.RemoveCallbacks(IMouseClickActions)" />
        /// <seealso cref="MouseClickActions.UnregisterCallbacks(IMouseClickActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="MouseClickActions" /> instance referencing this action map.
    /// </summary>
    public MouseClickActions @MouseClick => new MouseClickActions(this);
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "MouseClick" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="MouseClickActions.AddCallbacks(IMouseClickActions)" />
    /// <seealso cref="MouseClickActions.RemoveCallbacks(IMouseClickActions)" />
