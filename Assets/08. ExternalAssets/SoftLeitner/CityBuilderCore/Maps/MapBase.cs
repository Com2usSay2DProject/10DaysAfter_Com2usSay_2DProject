...
namespace CityBuilderCore
{
    ...
    public abstract class MapBase : MonoBehaviour, IMap, IGridOverlay, IGridPositions, IGridRotations
    {
        ...
        [Tooltip("visual shown as an overlay when building, is scaled to fit the map with one texture per cell")]
        public Renderer GridVisual;
        [Tooltip("deactivates the scaling of the grid visual in case that is done externally(for example when using MeshOverlayGenerator in DebugTerrain in Three)")]
        public bool GridVisualExternal;
