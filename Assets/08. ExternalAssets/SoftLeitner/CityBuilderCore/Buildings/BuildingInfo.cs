...
by default all the requirements have to be met")]
        ...
        public virtual IEnumerable<Vector2Int> GetPoints(BuildingMetaData metaData)
        {
            return PositionHelper.GetStructurePositions(metaData.Point, Size, BuildingRotation.Create(metaData.Rotation));
        }

        public virtual IBuilding Create(BuildingMetaData metaData, Transform parent)
        {
